...
export const philosophieContent = {
    ...
    items: [
      {
        ...
        description:
          "Rencontres philosophiques régulières pour explorer les grandes questions existentielles",
      ...
      },
      {
        title: "Cafés philo",
        description:
          "Ateliers de réflexion collective guidés pour apprendre à penser par soi-même et avec les autres",
      ...
      },
      {
        title: "Ciné philo",
        description:
          "Projections d'extraits de film suivies de discussions philosophiques enrichissantes",
  ...
  cta: {
    ...
    description:
      "Que vous soyez novice ou passionné, venez explorer avec nous les questions fondamentales de l'existence humaine",
