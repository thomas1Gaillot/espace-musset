        ...
        <div className="container mx-auto">
            ...
            <div className="text-center mb-12">
                <h1 className="font-serif text-4xl md:text-5xl font-bold text-foreground mb-6">
                    Écriture spontanée, laissez parler votre plume !
                </h1>
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                    Venez découvrir le plaisir d’écrire sans contraintes et libérer votre créativité chaque mois !
                </p>
            </div>
                ...
                <div className="flex flex-col justify-center space-y-6">
                    ...
                    <div className="space-y-4 text-muted-foreground">
                        <p>
                          ...
                          Au programme : exercices d’écriture spontanée, partage de textes et discussion animée par Béatrice.
                        </p>
                        <div className="bg-secondary/20 p-4 rounded-lg text-center font-medium text-foreground">
                           Atelier tous les 3ème jeudi du mois de 19h30 à 21h30
                        </div>
                    </div>
                </div>
            </div>
