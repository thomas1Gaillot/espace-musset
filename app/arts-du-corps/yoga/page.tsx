      ...
      <div className="container mx-auto">
        <Breadcrumb className="mb-8">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href={ROUTES.ARTS.ROOT}>Arts</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
        ...
        <div className="text-center mb-12">
          <h1 className="font-serif text-4xl md:text-5xl font-bold text-foreground mb-6">Yoga</h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Harmonisez corps et esprit à travers des pratiques douces et dynamiques adaptées à tous
            les niveaux dans un environnement bienveillant.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-12">
          ...
          <div className="flex flex-col justify-center space-y-6">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                Nos cours de yoga offrent un espace de paix et de reconnexion avec soi-même. Dans le
                respect des traditions ancestrales, nous adaptons la pratique aux besoins
                contemporains et à tous les corps.
              </p>
              <p>
                Que vous soyez débutant ou pratiquant expérimenté, nos séances vous accompagnent
                dans l'exploration de votre potentiel corporel et de votre sérénité intérieure.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg">Cours d'essai gratuit</Button>
