                      ...
                      <div className="space-y-2 my-6">
                        ...
                        <div className="text-xs font-semibold leading-tight flex flex-wrap gap-2">
                          {salle.activity.map((a, idx) => (
                            <div
                              key={idx}
                              className="px-4 py-2 flex items-center rounded-md  bg-primary/10"
                            >
                    ...
                    <div className="flex flex-col items-end gap-1">
                      ...
                      <div className="grid text-left sm:text-right text-sm">
                        {salle.prices.map((p, index) => (
                          <p key={p + index} className="font-light text-foreground">
                            {p}
                          </p>
                        ))}
                      </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-xs font-semibold leading-tight flex flex-wrap gap-2">
                      {salle.features.map((feature, idx) => (
                        <div
                          key={idx}
                          className="px-4 py-2 flex items-center rounded-md border border-primary/20"
                        >
...
function CarouselSalleDesMuses() {
  ...
  const images = ["/salle-des-muses.jpg", "/salle-des-muses-2.jpg", "/salle-des-muses-3.jpg"];
