...
const AteliersHebdos = () => {
  const recentAtelierHebdosEvent = eventList.filter(
    (e) => e.category.name === "Philosophie" && e.type.name === "Atelier philo"
  );
    ...
    <div className="py-12 mx-auto ">
      ...
      <div className="text-center mb-12 container">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          Chaque semaine, nous nous retrouvons pour explorer ensemble les grandes questions
          philosophiques dans un esprit de dialogue et de découverte.
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-12 mb-12 container">
        ...
        <div className="flex flex-col justify-center space-y-6">
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Nos ateliers hebdomadaires constituent le cœur de notre activité philosophique. Chaque
              semaine, nous nous réunissons pour explorer un thème différent autour des philosophies
              d'orient et d'occident.
            </p>
            <p>
              Ces rencontres s'articulent en trois partie : un cours, un repas convivial et un
              moment d'échange et de questions.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2  gap-8 mb-12 container">
        <div className="bg-earth-50/50  h-max rounded-lg p-6">
          ...
          <ul className="space-y-2 text-muted-foreground">
            <li>
              <strong>Quand :</strong> 1 fois par semaine, 19h30-22h00
            </li>
            <li>
              <strong>Où :</strong> Salle de cours au premier étage, 52 Bis Rue Alfred de Musset,
              31200 Toulouse
            </li>
            <li>
