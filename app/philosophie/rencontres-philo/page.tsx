...
const RencontresPhilo = () => {
  const recentRencontresPhilo = eventList.filter(
    (e) => e.category.name === "Philosophie" && e.type.name === "Rencontre philo"
  );
    ...
    <div className=" py-12 mx-auto">
        ...
        <div className="flex flex-col justify-center space-y-6">
          ...
          <div className="space-y-4 text-muted-foreground">
            ...
            <p>
              ...
              et <strong>{" le respect de la parole "} </strong>de chacun. Elle encourage la pensée
              autonome et l’expression claire des idées.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container grid md:grid-cols-3 gap-6 mb-12">
        ...
        <div className="bg-sage-50/50 rounded-lg p-6 text-center">
          ...
          <p className="text-muted-foreground">
            Présentation du sujet (15min)
            <br />
            + échanges en petit groupe (30min) <br />+ partage
          </p>
        </div>
        <div className="bg-earth-50/50 rounded-lg p-6 text-center">
          ...
          <p className="text-muted-foreground">à partir de 6 €</p>
        </div>
      </div>
