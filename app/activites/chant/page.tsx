    ...
    <div className="container mx-auto">
      ...
      <div className="flex flex-col  sm:flex-row   gap-12 mb-12">
        ...
        <div className="flex flex-col justify-center space-y-6">
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Cet atelier est ouvert à tous, débutants ou expérimentés. Au programme : échauffement
              vocal, chanter à plusieurs voix (canons et polyphonie). Pour finir, improvisation
              guidée.
            </p>
      ...
      <div className="text-center bg-secondary/10 p-4 rounded-lg flex flex-col items-center">
        ...
        <p className="text-sm text-muted-foreground mt-2">
          <CoffeeIcon className="inline-block mr-1 mb-1" size={14} />+ 5 € d'adhésion
        </p>
        <p className="text-sm text-muted-foreground mt-2">
