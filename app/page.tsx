...
export default function HomePage() {
  const activities = [
    ...
    },
    {
      ...
      href: "/philosophie",
      color: "bg-earth-medium/10 hover:bg-earth-medium/20",
    },
    {
      title: "Arts du corps",
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative h-[70vh] bg-gradient-to-br from-sage/20 to-earth-medium/20 flex items-center">
      ...
      <section className="py-16 bg-cream">
        <div className="container mx-auto px-4">
          ...
          <div className="bg-gradient-to-r from-sage/10 to-terracotta/10 rounded-2xl p-8 text-center">
            <Calendar className="w-16 h-16 text-sage mx-auto mb-4" />
            ...
            <Button className="bg-sage hover:bg-sage/80 text-cream">Voir l'agenda complet</Button>
          </div>
        </div>
      </section>
