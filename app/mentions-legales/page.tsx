        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <div className="text-muted-foreground space-y-2">
              <p>
                <strong>Raison sociale :</strong> Association Espace Musset
              </p>
              <p>
              ...
              <p>
                <strong>Numéro SIRET :</strong> XXX XXX XXX XXXXX
              </p>
            </div>
          </section>

          <section>
            <h2 className="font-serif text-2xl font-semibold text-foreground mb-4">Hébergement</h2>
            <p className="text-muted-foreground">Ce site est hébergé par OVH.</p>
          </section>
