        ...
        <div className=" w-full  shadow-sm h-full flex flex-col">
          ...
          <div className="grid grid-cols-7 border-b border-secondary/20">
            {daysOfWeek.map((day) => (
              <div
                key={day}
                className="p-2 sm:p-3 text-[10px] sm:text-xs  font-light text-gray-600 text-end"
              >
                {day}
              </div>
            ))}
                  ...
                  {date && (
                    <>
                      ...
                      <div className="space-y-1  overflow-hidden">
                        ...
                        {hasMoreEvents && (
                          <div className="text-[10px] sm:text-xs text-gray-500 px-1 sm:px-2 py-1">
                            +{dateEvents.length - 2} autre{dateEvents.length - 2 > 1 ? "(s)" : ""}
                          </div>
                        )}
                      </div>
                    </>
